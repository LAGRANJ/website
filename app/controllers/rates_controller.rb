class RatesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @rate.save
        format.html {
          GetCurrencyRatesJob.set(wait: 10.seconds).perform_later(cookies[:userid], 'Rate was successfully created.');
          logger.debug(cookies[:userid]);
  ...
  private
    ...
    def rate_params
      params.require(:rate).permit(:sym, :rate)
    end
end
