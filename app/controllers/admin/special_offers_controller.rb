class Admin::SpecialOffersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @special_offer.save
        format.html { redirect_to admin_special_offer_path(@special_offer) , notice: 'Special offer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @special_offer.update(special_offer_params)
        format.html { redirect_to admin_special_offer_path @special_offer, notice: 'Special offer was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_special_offers_url, notice: 'Special offer was successfully destroyed.' }
  ...
  def special_offer_params
    params.require(:special_offer).permit(:caption, :description, :body, :creation_date, :priority, :image, :caption_text_color, :description_text_color, :enabled)
  end
end
