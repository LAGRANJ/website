...
class Admin::CreditTypesControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create credit_type" do
    assert_difference('CreditType.count') do
      post credit_types_url, params: { credit_type: {  } }
    end
  ...
  test "should update credit_type" do
    patch credit_type_url(@credit_type), params: { credit_type: {  } }
